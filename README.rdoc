= I'm Learning Ruby With Ruby Koans

This is my attempt at completing all the tests in Ruby Koans so obviously be careful 
as they contain answers. Since I'm learning Ruby along the way I have included 
in depth notes as I complete each of the test files for reference. I come from an 
AS3/JS background so you'll see references to that in the notes. Feel free to fork and update the notes. Would certainly help me a great deal and I'll accept the pull request.
